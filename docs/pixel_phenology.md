...
| Parameter | `config.local.env` | CLI flag | Default | Effect |
|---|---|---|---|---|
...
| Parameter | `config.local.env` | CLI flag | Default | Description |
|---|---|---|---|---|
...
| `--output-dir PATH` | `PIXEL_OUTPUT_DIR` | `${OUTPUT_DIR}/pixel_phenology_metrics` | Root output directory |
